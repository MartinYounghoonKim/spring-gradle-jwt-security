...
public class AuthController {
	...
	@PostMapping("/sign-in")
	public WebResponseDto signIn (@Valid @RequestBody AuthDto authDto, HttpServletResponse response) {
		return WebResponseDto.success(accountService.signIn(authDto, response));
	}
	@GetMapping("/verify")
